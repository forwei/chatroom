...
class Skin extends React.Component {
  constructor(props) {
    ...
    this.skinImg = [
      ...
      {thumbImg: '/assets/img/bg-timg2.jpg', largeImg: '/assets/img/bg-limg2.jpg'},
      {thumbImg: '/assets/img/bg-timg3.jpg', largeImg: '/assets/img/bg-limg3.jpg'},
      {thumbImg: '/assets/img/bg-timg4.jpg', largeImg: '/assets/img/bg-limg4.jpg'},
      {thumbImg: '/assets/img/bg-timg5.jpg', largeImg: '/assets/img/bg-limg5.jpg'},
      {thumbImg: '/assets/img/bg-timg0.jpg', largeImg: '/assets/img/bg-limg0.jpg'},
      {thumbImg: '/assets/img/bg-timg0.jpg', largeImg: '/assets/img/bg-limg0.jpg'},
      {thumbImg: '/assets/img/bg-timg0.jpg', largeImg: '/assets/img/bg-limg0.jpg'},
      {thumbImg: '/assets/img/bg-timg0.jpg', largeImg: '/assets/img/bg-limg0.jpg'},
